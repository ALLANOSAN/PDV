  ...
  return (
    <div className="p-8 space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter uppercase">
            Essência Cosméticos - Caixa
          </h2>
          <p className="text-slate-500 dark:text-slate-400 font-medium">
            Controle as entradas e saídas do seu caixa.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div
          className={`p-8 rounded-[2.5rem] border-2 transition-all shadow-xl shadow-slate-100 dark:shadow-none flex flex-col justify-between min-h-[300px] ${isClosed ? "bg-red-50 border-red-100 dark:bg-red-900/10 dark:border-red-900/30" : "bg-emerald-50 border-emerald-100 dark:bg-emerald-900/10 dark:border-emerald-900/30"}`}>
          <div>
            <div
              className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-6 ${isClosed ? "bg-red-100 text-red-600" : "bg-emerald-100 text-emerald-600"}`}>
            ...
            {isClosed ? (
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-red-300">
                    R$
                  </span>
                  <input
                    type="number"
        ...
        <div className="p-8 rounded-[2.5rem] border-2 border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl shadow-slate-100 dark:shadow-none">
          <h3 className="text-sm font-black text-slate-400 uppercase tracking-widest mb-8 flex items-center gap-2">
            <TrendingDown size={18} className="text-indigo-500" /> Movimentação
            Avulsa
          </h3>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-slate-300">
                  R$
                </span>
                <input
            ...
            <div>
              ...
              <input
                className="w-full bg-slate-50 dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 p-4 rounded-2xl font-bold outline-none focus:border-indigo-500 transition-all"
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <button
                ...
                className="group bg-slate-100 hover:bg-red-50 text-slate-600 hover:text-red-600 p-5 rounded-2xl font-black transition-all flex flex-col items-center gap-2">
                <TrendingDown
                  size={24}
              ...
              <button
                ...
                className="group bg-slate-100 hover:bg-blue-50 text-slate-600 hover:text-blue-600 p-5 rounded-2xl font-black transition-all flex flex-col items-center gap-2">
                <TrendingUp
                  size={24}
                  className="group-hover:scale-110 transition-transform"
                />
